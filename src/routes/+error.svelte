...
<div
	id="about"
	class=" bg-white div -mt-[1px] items-stretch w-full flex flex-col justify-center"
>
	<Header fix={true} />
	<div class="sm:grid flex flex-col-reverse items-center justify-center grid-cols-1 sm:grid-cols-2 w-full h-full">
		...
		>
			<h1 class="text-2xl font-semibold">Invalid Request</h1>
			<h1 class="text-2xl mt-2 font-semibold">404</h1>
			
			<p class="mt-10">Don't hesitate to reach out to me</p>
