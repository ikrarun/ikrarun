...
<header
	class={visible
		? 'fixed w-full bg-black/20 transition-all duration-150 ease-in-out  top-0 -mt-[1px] z-[100]'
		: 'fixed -top-96 bg-black/20 transition-all duration-150 ease-in-out w-full z-[100]'}
>
